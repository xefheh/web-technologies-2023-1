...
const snake = {
   ...
   */
  makeStep() {
    const head = this.snake.getNextStepHeadPoint();
...
const game = {
  ...
  getRandomFreeCoordinates() {
    ...
    } while (this.snake.isOnPoint({x, y}))
    return {x, y};
  },
  ...
  canSetDirection(direction) {
    let lastDirection = this.snake.getLastStepDirection();
    return !(
   ...
   */
  canMakeStep() {
    return !this.snake.isOnPoint(
        this.snake.getNextStepHeadPoint()) &&
        this.snake.getNextStepHeadPoint().x <= this.config.getColsCount() &&
        this.snake.getNextStepHeadPoint().y <= this.config.getRowsCount();
  },
};
